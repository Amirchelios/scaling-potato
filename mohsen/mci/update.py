...
def replace_content_in_selected_files():
    """
    این تابع محتوای فایل منبع (که از قبل تعیین شده است) را در فایل‌های انتخاب شده توسط کاربر جایگزین می‌کند.
    """

    source_file = "update.txt"  # مسیر فایل منبع را در اینجا وارد کنید
